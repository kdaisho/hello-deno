...
```
docker run --network=deno-net --platform linux/amd64 -p 3011:3011 --name=deno-net --rm deno:1
```
...
_-p = publish, 3011:3011 = maps port 3011 (right) to 3011 (left) to expose_
